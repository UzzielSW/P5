 ...
 *               2018/11/20,21,22
 * Programa Servidor que genera el objeto 
 *
 */
...
/*     infinito =String.valueOf(linea.m);
...
// jtfB.setText(infinito);
 ...
 //JOptionPane.showMessageDialog(this,"La linea es de: "+linea.imprime_linea()+ "");
...
public	 String imprime_linea()
{
 ...
 if (b >= 0.0)
  s="y = "+this.m+"x " + "+ "+ b + " :" +punto1.display()+"-"+punto2.display();
 else if ( b < 0)
  s= "y = "+this.m+"x " + b + " :" +punto1.display()+"-"+punto2.display();	
 return(s);   
}
...
public	 String imprime_linea2(){
		return("x = "+punto1.getx() + " : "+p1.display()+" - "+p2.display());
	}	
