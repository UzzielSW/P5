...
public class ClienteSocketLinea extends JFrame implements ActionListener {
    private JButton jbtPend, jbtGraficar, jbtExit, jbtClear;
    public Punto punto1;
    public Punto punto2;
    Linea lineacliente;
    ...
    */
    ...
    public String infinito, infinito2;
...
*/
        ...
        p2.add(jbtGraficar = new JButton("Graficar"));
        ...
        jbtGraficar.addActionListener(this);
        ...
        if (e.getSource() instanceof JButton) {
            if ("Pendiente".equals(actionCommand)) {
                ...
                try {
                    ...
                    lineacliente = new Linea(punto1, punto2);

                    lineacliente.validaPuntos(punto1, punto2);
                    ...
                    clearText();
                    return;
                } catch (PuntosIgualesException p) {
                    JOptionPane.showMessageDialog(this,
                        "Los Puntos: Son Iguales",
                        " Esto es un ERROR \n Ingrese puntos distintos",
                        JOptionPane.ERROR_MESSAGE);
                    clearText();
                    return;
                }
                ...
                try {
                    ...
                    System.out.println(" Si o no " + lineacliente.existe);

                    if (lineacliente.existe == true) {
                        ...
                        if (lineacliente.getPendiente() != 0.0) {

                            System.out.println("\n Interseccion Eje x: " +
                                lineacliente.ejeX.display());

                            System.out.println("\n Interseccion Eje y: " +
                                lineacliente.ejeY.display());
                            JOptionPane.showMessageDialog(this, "La linea es de: " +
                                lineacliente.imprime_linea() +
                        ...
                        infinito2 = String.valueOf(lineacliente.getB());

                        if (infinito2.equals("NaN")) {
                            infinito2 = "Infinity";
                            jtfB.setText(infinito2);
                        }
                        ...
                        JOptionPane.showMessageDialog(this,
                            ...
                            JOptionPane.ERROR_MESSAGE);
                        JOptionPane.showMessageDialog(this,
                            "La linea es de: " + lineacliente.imprime_linea2() +
                            "\n Interseccion Eje x: " + lineacliente.ejeX.display());
            ...
            else if ("Graficar".equals(actionCommand)) {
                //JOptionPane.showMessageDialog(this,"La Pendiente No Existe"," ",JOptionPane.ERROR_MESSAGE);
                JOptionPane.showMessageDialog(this,
                    "We are working in that... ", "Comming  Soon ", JOptionPane.ERROR_MESSAGE);
    ...
    public	 String imprime_linea()
    {
     ...
     if (b > 0.0)
      s="y = "+this.m+"x " + "+ "+ b + " :" +
      lineacliente.getP1().display()+"-"+lineacliente.getP2().display();
     else if ( b < 0)
      s= "y = "+this.m+"x " + b + " :" +
      lineacliente.getP2().display()+"-"+lineacliente.getP2().display();	
     else
          s="y = "+this.m+"x " + " :" +
          lineacliente.getP1().display()+"-"+
          lineacliente.getP2().display();
     return(s);   
    }
    ...
    */
    ...
    temp.y=(-(a.p2.x-a.p1.x)*((-(this.p2.y-this.p1.y)-this.m)/
    (this.p2.x-this.p1.x))-a.m)/(a.p2.y-a.p1.y);
    temp.x=(-(a.p2.y-a.p1.y)*((-(this.p2.x-this.p1.x)-this.m)/
    (this.p2.y-this.p1.y))-a.m)/(a.p2.x-a.p1.x);
    return(temp);
    	}
    */
