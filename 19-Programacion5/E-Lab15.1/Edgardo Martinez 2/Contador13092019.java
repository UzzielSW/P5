...
public class Contador13092019 extends JFrame implements ActionListener,  Runnable{
	private static final long serialVersionUID = 1L;
	
	public JButton go;
	
	public JButton suspenderBoton = new JButton("Suspender");
    public JButton reanudarBoton = new JButton("Reanudar");
    public JButton stopBoton = new JButton("Stop");
    public JButton limpiarBoton = new JButton("Limpiar");
...
class Maine {
	...
	public static void main(String []args){
		Contador13092019 obj= new Contador13092019();
		obj.lanzador();
	}
