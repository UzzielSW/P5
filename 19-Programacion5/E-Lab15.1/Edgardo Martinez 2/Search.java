...
import java.util.Scanner;
 ...
 class Main {
	...
	public static void main(String args[]) {
		...
		System.out.print("Tamaño del arreglo: "); tam=cin.nextInt();
		...
		for (int i=0;i<tam;i++){
		 ...
		 if (i!=0){ for (int j=0;j<i;j++){
		     if (arreglo[j] == arreglo[i]){ i=i-1; break;  }
			}
		  }
		}
		
		
		for (int i=0;i<tam;i++){ System.out.print(arreglo[i] + " "); }
		 
		 System.out.print("\nCantidad de Hilos: "); cantidad_hilos=cin.nextInt();
		 System.out.print("\nNumero a encotrar: "); numberToFind=cin.nextInt();
...
public class Search implements Runnable {
	...
	public void run() {
		...
		if(noFind == false){ System.out.println("Hilo " + numeroDeHilo + ": numero no encontrado!");   
		}
	}//RUN
