...
public class TempCoverter6b extends JFrame 
{
...
// Menu items "Celsius To Farenheit", "Farenheit to Celsius", "Multiply","Divide" and "Close"
  private JMenuItem jmiCelToFar, jmiFarToCel, 
	...
	public  TempCoverter6b(String title)
	{
		super(title);
...
Temp6CTFListener CTFListener = new Temp6CTFListener( );
		...
		jtextCel.addKeyListener(CTFListener);
		jtextFar.addKeyListener(CTFListener);
	
	jmiCelToFar.addActionListener(CTFListener);
    jmiFarToCel.addActionListener(CTFListener);
    
    jmiClose.addActionListener(CTFListener);
    jmiLimpiar.addActionListener(CTFListener);
...
if ( !(sjtextC.equals("") || sjtextF.equals("")) ||
     ( sjtextC.length() != 0  || sjtextF.length()  != 0))    
  {
   ...
   jtextFar.setText(cad);
	...
	JFrame frame = new TempCoverter6b("inner class Celsius-Farenheit-Celsius " +
	                "\n Temp6CTFListener " );
...
public class Temp6CTFListener implements ActionListener,
                                            KeyListener
{
