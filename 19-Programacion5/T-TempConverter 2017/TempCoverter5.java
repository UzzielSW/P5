...
public class TempCoverter5 extends JFrame 
{
	...
	public  TempCoverter5(String title)
	{
		super(title);
...
TempCTF5Listener CTF5Listener =
                    new TempCTF5Listener( this,jb,jt);
	...
	{
		JFrame frame = new TempCoverter5("Celsius-Farenheit-Celsius"+
		  "\n TempCTF5bListener");
