...
/**
 * <code>GUIRaceCar</code> es una clase que extiende a <code>Thread</code> la cual se encarga de
 * el manejo de los autos de carreras. Todos los objetos creados a partir de <code>GUIRaceCar</code>
 ...
 * @see GUIRace
 */
public class GUIRaceCar extends Thread
{
	//private int finish;
	private String name;
	private JProgressBar jpBar;
	private JTextField jtField;
	private GUIRace race;
     ...
     */
    public GUIRaceCar(String n, JProgressBar jpb, JTextField f, GUIRace r) 
    {
    	jpBar = jpb;
    	name = n;
    	jtField = f;
     ...
     */
    public static synchronized String getPosition(GUIRace race)
    {
