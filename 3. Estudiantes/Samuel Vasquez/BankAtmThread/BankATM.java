...
public class BankATM implements ActionListener
{
	...
	{
		//se instancia un objeto de la interface Runnable
		Runnable r = new Runnable()
		{
			public void run()
			{
				//se llama a la clase BankATM
				new BankATM("First BankATM 1 In Java");
				new BankATM("First BankATM 2 In Java");
			}
		};
