 ...
 *           the move method.  This class extends the 
 *           MoveController class, and the methods here use
 *           the MoveController myPath and object's lock to
 *           implement the cooperative synchrnoization needed
 *           to move the ball in a thread.
 */
