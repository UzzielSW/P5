...
/*
 *  Purpose: This program shows how to use the composition
 *           designed version of the animator to implement
 *           the move method.  This creates a variable for
 *           the MoveController object, and then calls the 
 *           methods on that MoveController object to 
 *           manipulate the path.
 */
...
public class ConcurrentBall implements DrawListener, Runnable {
    ...
    */
    ...
    public void run() { 
        ...
        try {
            while(true) {
                mc.move(new StraightLinePath(410, 205, 10, 205, 50));
                Thread.sleep(random.nextInt(10000));

                mc.move(new StraightLinePath(10, 205, 410, 205, 50));
                Thread.sleep(random.nextInt(10000));
            }
