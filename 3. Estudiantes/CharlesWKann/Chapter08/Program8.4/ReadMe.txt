...
This program solves the lock problem in program 8.2 by only synchronizing
the wait call in the Ball's thread.  However this is incorrect again because
it can lead to a race condition
