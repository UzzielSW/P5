...
import java.io.*;
	 ...
	 *En ella se ejerce el control de registro de Usuario(nuevo cliente).
	 *@version 1.0
	 */
...
public class Register
{
	 ...
	 *En el se ejecuta el control de registro de usuarios, tambien se crea la Interfaz gráfica en donde interactuará el usuario.
	 *@param d Trae una referencia de La Clase Principal, la cual extiende de JFrame
	 */
