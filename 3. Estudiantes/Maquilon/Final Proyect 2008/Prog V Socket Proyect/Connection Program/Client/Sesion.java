...
public class Sesion implements java.io.Serializable
{
	...
	;
			...
			n = String.valueOf(name2.getText());
        	p = String.valueOf(pass2.getText());
        	
        	///////////////////////////////////////////////
        					    			        						
        	////   RESCUE VALUES    ////    --->    SERVER				
		 ...
		 *@param p trae la referencia de la contraseña del cliente, sumnistrada en el constructor Sesion
		 *@version 1.0
		 */
	...
	////////////////////////////////////////////////////////////////////////////////////
     ...
     public void iniciarSesion(String answer)
     {		
     		if(answer.equals("no"))
     ...
     public void iniciarSesion(String answer,String name,String lastName,String Id,String m)
     {
     		nameP = name;
     	
     //		System.out.println("Hola "+nameP);
			welcome = new JLabel("Welcome "+nameP+" "+lastName+"    ID: "+Id);  
        	welcome.setBounds(50,-50,400,200);
	    	Date fecha = new Date();
			sal = new JLabel("Your balance today, "+fecha+" is: "+m);
	...
	{		
			...
			/////////////////////////////////////////////////////////
				  ...
				  dep = withdr.getText();		deposito.hide();
	...
	public void isDeposited(String answer)
	{
		if(answer.equals("si"))
		{        	
			progressD();
	...
	{
		ProgressD waiting = new ProgressD();
		
		try
		{
			Thread t1 = new Thread(waiting,"deposit");
   ...
   //  BALANCE 
    ...
    public void Balance(JFrame d,String Balance)
	{
			f = d;		
			Balanze = Balance;
	...
	public void isWithdraw(String answer)
	{
		if(answer.equals("si"))
		{        	
			progressW();
	...
	public synchronized void progressW()
	{
		ProgressW waiting = new ProgressW();
		
		try
		{
			Thread t1 = new Thread(waiting,"withdraw");
