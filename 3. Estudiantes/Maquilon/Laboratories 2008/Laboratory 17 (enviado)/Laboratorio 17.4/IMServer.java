...
public class IMServer implements Runnable
{
	...
	public void run()
	{
		...
		usuarios = new Participant(nombre,desdeUsuario);
		
		usuarios.start();
		
	/*	OutputStream paraUsuario = usuario.getOutputStream();
		
		DataOutputStream enviar = new DataOutputStream(paraUsuario);
		
		enviar.writeUTF("Recibido...!");*/
