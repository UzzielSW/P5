...
public class Cashier extends JPanel{
	 ...
	 private CashierListener manejador;
	 private Bank bank;
	 ...
	 public Cashier(Bank bank, String nombreCajero){
      ...
      private void addTeclado(){//metodo para adicionar los componentes del teclado del cajero
      ...
      //metodo que retorna un objeto PantallaRunnable
	  ...
	  //metodo que retorna el  JLabel de la pantalla
