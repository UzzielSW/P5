...
/**Clase  encargada de crear la interfaz gráfica del banco.*/
public class Bank extends JFrame{
	...
	/**El parametro customers hara  instancia a  la clase Customer.*/
	public Customer customers[];
        /**El parametro accounts hara instancia a la clase Account.*/
	public Account accounts[];
        /**El parametro transaccion hace referencia al objeto ViewTransaction 
         creado en la clase SimulacionCajero.*/
	public ViewTransaction transaccion;
        /**El parametro manejador hara un instancia a la clase BankListener.*/
	public BankListener manejador ;
	
	/**Crea un Bank 
         @param transaccion Objeto ViewTransaction, para ver las transacciones realizadas.*/
	...
	/**Adicionando los componentes del primer panel .*/
	public void addPanel1(){
        ...
        /**Adicionando los componentes del segundo panel.*/
	...
	/**Método que retorna una cuenta de un cliente.
         @param i Indice del cliente en el arreglo de objetos Customer.*
         @return accounts[] Cuenta del cliente.*/
	...
	/**Método que retorna la cantidad de cuentas que tengamos.
         @return cantidad de clientes.*/ 
	public int getNumberOfAccounts(){
		
			return manejador.getNumberOfAccounts();
	}
	/**Método que encuentra un cliente por medio de su clave de cuenta.
         @param clave Clave de la cuenta de un cliente.*
         @return True si se encuetra el cliente, false en caso contrario.*/
	public boolean encuentraCliente(int clave){
        ...
        /**
     * Método que retorna la posición de un cliente en el arreglo de objetos Customer.
     * @return El indice de la cuenta del cliente.
     */
