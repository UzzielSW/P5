...
/**This is an inner class that represents the <code>JButton</code> used to close the <code>ViewAccount</code> window
  **/
public class Boton_Cerrar extends JDialog implements ActionListener,Runnable{
     ...
     */ 	
    	public Boton_Cerrar(BankWindow owner,Thread ownerThread)
    	{	super(owner,false);
    		this.owner=owner;
     ...
     public void paint(Graphics g){
    	super.paint(g);
    	this.setLocation(owner.getX()+owner.getWidth(),owner.getY()+owner.getHeight());
