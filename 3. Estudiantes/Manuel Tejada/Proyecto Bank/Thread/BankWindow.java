...
private final BankWindow mainWindow;
...
/**This methos is call to create a graphic representation of a bank
 *By creating a BankWindow instance*/
    public BankWindow() {
    	
		setTitle("...:::Wardmatc Bank:::...");
   	  	miBanco=new Banco(); 
   	   	//setUndecorated(true);
    	...
    	for(int i=0;i<=9;i++){
    		...
    		jb_num[11].addActionListener(new ActionListener(){
    			...
    			public void actionPerformed(java.awt.event.ActionEvent e){
    				...
    				synchronized public void cargaImagen(){
    ...
    public void creaMenuNormal(){
		...
		jmi_Login.addActionListener(new ActionListener(){
    			public void actionPerformed(java.awt.event.ActionEvent e){
    				...
    				synchronized public void creaVentana(){
    	...
    	jb_Deposit.addActionListener(new ActionListener(){
   		public void actionPerformed(ActionEvent e){
    			deposit(e);
    				...
    				synchronized public void deposit(ActionEvent e){
    	...
    	jb_Withdrawal.addActionListener(new ActionListener(){
   		public void actionPerformed(ActionEvent e){
   			withdrawal(e);
    				...
    				synchronized public void withdrawal(ActionEvent e){
    ...
    *by callig the <code>Banco --> getNumOfCustomers()</code>  method that returns the size of the <code>Linkedlist</code> that stores the <code>Customer</code> objects. */
    ...
    public void save(){
    	try{
    		miBanco.guardaLista();
    			System.out.print("Exito guardando lista");
    	}
    	catch(Exception ex){
    		System.out.print("Error guardando lista");
    	}
