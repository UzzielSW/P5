 ...
 *@param owner is a <code>BankWindow</code> object that represents the owner of the <code>CrearCuentaWindow JDialog</code>*/
	public EditarCuentaWindow(BankWindow owner){
		super(owner,"...:::Edit Account:::...",false);
		this.owner=owner;
	...
	jchb_Enable=new JCheckBox("Enable",owner.getCustomerInfo(owner.getCurrentCustomer(),9)=="Habilitado");
	jchb_Disable=new JCheckBox("Disable",owner.getCustomerInfo(owner.getCurrentCustomer(),9)=="Desabilitado");
    ...
    public void makeChanges(){
    	...
    	if(jchb_Aux[6].isSelected())
    		client.setPasswordCustomer(""+jpf_password.getPassword());
