...
//	}
	...
	public void actionPerformed(ActionEvent e) {
		long tem = Long.parseLong(Cliente.Client("pass", ""+Math.round(Math.random() * 9999 + 1000), null, null, null, null));
		if (e.getActionCommand() == "add") {
			if (btg.getSelection().getActionCommand() == "Corriente") {
				etiqueta5.setText("" + tem);
				JOptionPane.showMessageDialog(null,	Cliente.Client("addclient", ""+tem, recuadro1.getText(), recuadro2.getText(), "-1", recuadro3.getText()));
			} else if (btg.getSelection().getActionCommand() == "Ahorro") {
				etiqueta5.setText("" + tem);
				JOptionPane.showMessageDialog(null, Cliente.Client("addclient", ""+tem, recuadro1.getText(), recuadro2.getText(), recuadro3.getText(), "-1"));}
		} else if (e.getActionCommand() == "Ok") {
			recuadrof23.setText(Cliente.Client("busnoap", recuadrof21.getText(), null, null, null, null));
			recuadrof22.setText(Cliente.tem2);
		} else if (e.getActionCommand() == "Listo") {
			JOptionPane.showMessageDialog(null,Cliente.Client("upclient", recuadrof22.getText(), recuadrof23.getText(), recuadrof21.getText(), null, null));
