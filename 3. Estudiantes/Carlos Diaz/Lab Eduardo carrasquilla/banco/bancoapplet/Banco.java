 ...
 /**
 * @author Eduardo Carrasquilla 8-816-792
 * @version 1.00 año 2010
 */
 
public class Banco extends JApplet implements  ActionListener {
    ...
    JTextField tf_1,tf_2; 	
    	...
    	public void init(){
    		...
    		this.add(p_i,BorderLayout.WEST);
    		this.add(p_d,BorderLayout.EAST);	
    	}
