 ...
 */
public class Create_User extends JDialog  implements ActionListener, ItemListener,Runnable
{
	...
	private int  a=0,h,s,acciontype=0;
	private int cuenta,vcuenta,x=0;
	private int p,open=0;
	private  long tem;
   	...
   	try
   	{
   		if(acciontype==1)
    	{
    		if(p==0)
    	 	...
    	 	Cliente.Client("add_client", ""+tem, jtxtnombre.getText(), jtxtapellido.getText(),TCuenta, jtxtapertura.getText());
    	...
    	if(acciontype==2)
    	{
        	 ...
        	 String Change = Cliente.Client("update_client",jtxtcodcuenta2.getText(),cambia_nombre,cambia_apellido,null,null);
        	 JOptionPane.showMessageDialog(null,"Change user info: "+Change,"Information",JOptionPane.INFORMATION_MESSAGE);	
        	 this.setVisible(false);
    	}
    	if(acciontype==3)
    	{
