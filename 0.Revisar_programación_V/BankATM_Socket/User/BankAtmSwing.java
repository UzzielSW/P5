    ...
    public void run()
  	{
  		try
  		{
  		    ...
  		    if(acciontype==2)
  			{
  			  try
       	   	  {
       	          amount = JOptionPane.showInputDialog(null,"How much do you want to deposit?","Deposit",JOptionPane.QUESTION_MESSAGE);
       	   	  ...
       	   	  catch(RuntimeException e1)
			  {
			      ...
			      JOptionPane.showMessageDialog(this,"Please type numeric character into the Data Entry and Press deposit Button","Information",JOptionPane.INFORMATION_MESSAGE);
  			      return;
			  }
  			}
  			if(acciontype==3)
  			{
			    ...
			    {
				    jtfMsn.setText("Type numeric character into the Data Entry");
				    JOptionPane.showMessageDialog(null,"Please type numeric character into the Data Entry and Press Withdraw Button","Information",JOptionPane.INFORMATION_MESSAGE);
				    return;
			    }
  			}
