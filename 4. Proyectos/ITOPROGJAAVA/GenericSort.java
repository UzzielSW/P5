...
public class GenericSort {
  public static void main(String[] args) {
    ...
    // Declare and create an Double array
    Double[] doubleArray = {new Double(3.4), new Double(1.3),
      new Double(-22.1)};

    // Declare and create a Rational array
    Rational[] rationalArray = {new Rational(1, 2),
      new Rational(2, 3), new Rational(3, 5)};
    ...
    System.out.print("Sorted Rational objects: ");
    printList(rationalArray);
