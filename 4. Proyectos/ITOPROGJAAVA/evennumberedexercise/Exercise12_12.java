// Exercise12_12.java: Use CardLayout
import java.awt.*;
import java.awt.event.*;
import java.util.*;
import javax.swing.*;

public class Exercise12_12 extends JApplet
  ...
  public static void main(String[] args) {
    ...
    Exercise12_12 applet = new Exercise12_12();
  ...
  public void init() {
    ...
    //register listener with the munu items
    jmiInt.addActionListener(this);
    jmiRat.addActionListener(this);
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (e.getSource() instanceof JMenuItem) {
      if ("Integer".equals(actionCommand))
        queue.first(cardPanel);
      else if ("Rational".equals(actionCommand))
