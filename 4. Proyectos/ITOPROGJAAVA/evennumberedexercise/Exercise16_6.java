// Exercise16_6.java: Create a customizable animation applet
import java.awt.*;
...
public class Exercise16_6 extends JApplet implements ActionListener {
  ...
  public static void main(String[] args) {
    // Create a frame
    JFrame frame = new JFrame("Exercise 16.6");

    // Create an instance of the applet
    Exercise16_6 applet = new Exercise16_6();
