// Exercise18_2Server.java: Rewrite Example 16.2 using GUI
import java.io.*;
import java.net.*;
import java.util.*;
import java.awt.*;
...
public class Exercise18_2Server extends JFrame {
  private JTextArea jta = new JTextArea();

  public static void main(String[] args) {
    new Exercise18_2Server();
  }

  public Exercise18_2Server() {
    // Place text area on the frame
    getContentPane().setLayout(new BorderLayout());
    getContentPane().add(new JScrollPane(jta), BorderLayout.CENTER);

    // It is necessary to show the frame here!
    setTitle("Exercise18.2: Server");
    setSize(500, 300);
    setVisible(true);
