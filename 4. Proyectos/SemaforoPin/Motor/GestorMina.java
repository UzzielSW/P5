...
public class GestorMina {
	...
	private EstadoMotor comprobarAcci—nMotor (EstadoMotor estadoMotor)
	{
	...
	public  synchronized void notificarNivelAgua (int nivelAgua)
	{
		...
		nuevoEstadoMotor = comprobarAcci—nMotor (nuevoEstadoMotor);
	...
	public  synchronized EstadoMotor obtenerAcci—nMotor() throws InterruptedException
	{
		...
		//  la hebra que controle el motor continœe con la ejecuci—n de este mŽtodo.
