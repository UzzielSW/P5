 ...
 * generated in the com.jaxrpc package. 
...
public class ObjectFactory {
    ...
    private final static QName _DisplayResponse_QNAME = new QName("http://JaxRPC.com/", "displayResponse");
    private final static QName _Display_QNAME = new QName("http://JaxRPC.com/", "display");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.jaxrpc
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://JaxRPC.com/", name = "displayResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://JaxRPC.com/", name = "display")
