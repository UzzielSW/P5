 ...
 * generated in the com.webws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Display_QNAME = new QName("http://WebWS.com/", "display");
    private final static QName _DisplayResponse_QNAME = new QName("http://WebWS.com/", "displayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.webws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebWS.com/", name = "display")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebWS.com/", name = "displayResponse")
