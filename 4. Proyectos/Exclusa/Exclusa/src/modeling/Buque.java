...
public class Buque {
    ...
    public int posicion;
   /**El campo altura indica la altura que tome el objeto Buque cuando
    *se estan llenando los objetos Exlcusa  de agua. */
    public int altura=0;
    ...
    {
        max_velocidad=1; velocidad=0;  p_inicial=-45;
        p_final=p_inicial;  posicion=p_inicial;
        altura=0;
    }
}
