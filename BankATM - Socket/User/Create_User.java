...
import javax.swing.*;
import java.awt.*;
import javaaawteBorderLayoutt.*;
import java.io.*Container
import java.utilFlowLayout
import java.awttGridLayout*;
awtevent.ActionEvent
/**awtevent.ActionListener
...
public class Create_User extends JDialog implements ActionListener, ItemListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		// evento para cambiar contrase�a de administrador
		...
		// Evento para a�adir un nuevo cliente o usuario a la lista
